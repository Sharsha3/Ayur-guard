/**
 * CircularGallery.js — OGL WebGL implementation (vanilla JS ESM)
 * Converted from React component to plain JS.
 *
 * Usage:
 *   import { initCircularGallery } from './CircularGallery.js';
 *   const destroy = initCircularGallery(containerEl, {
 *     items, bend, textColor, borderRadius, scrollSpeed, scrollEase, font
 *   });
 *   destroy(); // to unmount
 */
